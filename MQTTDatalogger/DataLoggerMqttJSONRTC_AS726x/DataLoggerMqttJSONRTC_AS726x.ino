/*
  ...
  Uses the following libraries:
   ...
   http://librarymanager/All#Sparkfun_AS726X (for the sensor)
...
*/
void readSensor() {
  // Read all 6 channels. This takes several seconds:
  sensor.takeMeasurements();

  if (sensor.getVersion() == SENSORTYPE_AS7262) {
    //Visible readings
    body["V"] = sensor.getCalibratedViolet();
    body["B"] = sensor.getCalibratedBlue();
    body["G"] = sensor.getCalibratedGreen();
    body["Y"] = sensor.getCalibratedYellow();
    body["O"] = sensor.getCalibratedOrange();
    body["R"] = sensor.getCalibratedRed();
  }
  ...
  body["Temp"] = sensor.getTemperatureF();
